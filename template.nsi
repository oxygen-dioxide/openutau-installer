...
Section "MainSection" SEC01
  ...
  File "OpenUtau-win-{arch}\Microsoft.DiaSymReader.Native.{xarch}.dll"
  ...
  File "OpenUtau-win-{arch}\mscordaccore_{xarch}_{xarch}_5.0.1722.21314.dll"
...
Section Uninstall
  ...
  Delete "$INSTDIR\mscordaccore_{xarch}_{xarch}_5.0.1722.21314.dll"
  ...
  Delete "$INSTDIR\Microsoft.DiaSymReader.Native.{xarch}.dll"
